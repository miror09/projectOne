/**
	© Copyright Miroslav Richter 2017, ALL RIGHTS RESERVED.
 */
...
import com.filenet.apiimpl.core.*;
...
/**
 * Launches resetRQ application.
 */

public class resetRQLauncher
{
	...
	try
		...
		ce = new CEConnection();
		ce.establishConnection("GCDAdmin","sys","FileNetP8","t3://localhost:7001/FileNet/Engine/");
